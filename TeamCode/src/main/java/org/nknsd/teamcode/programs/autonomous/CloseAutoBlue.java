...
public class CloseAutoBlue extends NKNProgram {
    @Override
...
//        auto states
        ...
        StateMachine.INSTANCE.addState("move to spike", new AutoMoveToPosState(autoPositioner, absolutePosition, true, -20, -38, 2.37, 1, 1, 0.1, 1, RobotVersion.INSTANCE.pidControllerX, RobotVersion.INSTANCE.pidControllerY, RobotVersion.INSTANCE.pidControllerH, new String[]{}, new String[]{"intake", "intake 1st ball", "timer 1"}));
        StateMachine.INSTANCE.addState("intake", new AutoIntakeAllState(artifactSystem, new String[]{}, new String[]{}));
        StateMachine.INSTANCE.addState("intake 1st ball", new AutoMoveToPosState(autoPositioner, absolutePosition, false, -23.5, -32.5, 2.37, 1, 1, 0.1, 1, pidControllers[0], pidControllers[1], pidControllers[2], new String[]{}, new String[]{}));
        StateMachine.INSTANCE.addState("timer 1", new TimerState(1000, new String[]{"intake 2nd ball", "timer 2"}, new String[]{}));
        StateMachine.INSTANCE.addState("intake 2nd ball", new AutoMoveToPosState(autoPositioner, absolutePosition, false, -26, -30, 2.37, 1, 1, 0.1, 1, pidControllers[0], pidControllers[1], pidControllers[2], new String[]{}, new String[]{}));
        StateMachine.INSTANCE.addState("timer 2", new TimerState(1000, new String[]{"intake 3rd ball", "timer 3"}, new String[]{}));
        StateMachine.INSTANCE.addState("intake 3rd ball", new AutoMoveToPosState(autoPositioner, absolutePosition, false, -29.5, -26.2, 2.37, 1, 1, 0.1, 1, pidControllers[0], pidControllers[1], pidControllers[2], new String[]{}, new String[]{}));
