...
public class PeakTargetTester extends NKNProgram {
    ...
    public void createComponents(List<NKNComponent> components, List<NKNComponent> telemetryEnabled) {
        ...
        StateMachine.INSTANCE.addState("start", new AutoMoveToPosState(setup.getAutoPositioner(), setup.getAbsolutePosition(), true,
                new double[]{0, 0, Math.PI/2}, 1, 1, 0.05, 1, RobotVersion.INSTANCE.pidControllerX, RobotVersion.INSTANCE.pidControllerY, RobotVersion.INSTANCE.pidControllerH,
                new String[]{}, new String[]{"intake 2"}));
