...
public class ArtifactSlotTester extends NKNProgram {
    ...
    private class ScanSlotsTestState extends StateMachine.State {

        @Override
        protected void run(ElapsedTime runtime, Telemetry telemetry) {
            if(artifactSystem.isReady() && runtime.milliseconds() > startTimeMS + 100){
    ...
    public void createComponents(List<NKNComponent> components, List<NKNComponent> telemetryEnabled) {
        ...
        StateMachine.INSTANCE.startAnonymous(new ScanSlotsTestState());
    }
}